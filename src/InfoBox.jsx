...
export default function InfoBox({info}) {
    ...
    const RAIN_URL = "https://images.unsplash.com/photo-1493314894560-5c412a56c17c?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cmFpbnklMjB3ZWF0aGVyfGVufDB8fDB8fHww";
            ...
            <div className="cardContainer">
                <Card sx={{ maxWidth: 345 }}>
                    ...
                    <CardContent>
                        ...
                        <div>The weather can be described as {info.weather} and it feels like: {info.feelsLike}&deg;C</div>
